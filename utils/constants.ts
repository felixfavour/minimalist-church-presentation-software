...
/**
 * Number of chapters in each book of the Bible (66 books)
 * Indexed to match bibleBooks array (Genesis at index 0, Revelation at index 65)
 */
export const chaptersPerBook = [
  50, 40, 27, 36, 34, 24, 21, 4, 31, 24, 22, 25, 29, 36, 10,  // Genesis - Nehemiah
  10, 10, 42, 150, 31, 12, 8, 66, 52, 5, 48, 12, 14, 3, 9,    // Esther - Amos
  1, 4, 7, 3, 3, 3, 2, 14, 4,                                  // Obadiah - Malachi
  28, 16, 24, 21, 28, 16, 16, 13, 6, 6, 4, 4, 5, 3, 6,         // Matthew - 2 Timothy
  4, 3, 1, 13, 5, 5, 3, 5, 1, 1, 1, 22                         // Titus - Revelation
];
